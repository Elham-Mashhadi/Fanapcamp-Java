...
public class Main {
    public static void main(String[] args) {
        Student student1 = new Student("sahar","vahedi","123545545", Gender.Female,123,"1400","Math");
        Student student2 = new Student("fateme","yosefi","1425545545", Gender.Female,1234,"1400","History");
        Student student3 = new Student("ali","vahedi","123545545", Gender.Male,123,"1400","Physics");
        Student student4 = new Student("sara","vahedi","123545545", Gender.Female,123,"1400","Art");
